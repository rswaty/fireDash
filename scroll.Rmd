...
<font size="6"> If fire burned in squares every year. </font>


```{r fireSq, fig.height=7, fig.width=10}
knitr::include_graphics("fireSquares.png") 
```


<font size="6"> "Grouped" ecosystems map-long ago. </font>

```{r groupVeg, fig.height=7, fig.width=10}
...
```{r histoBar, fig.height=8, fig.width=11}
...
<font size="6"> Three stories. </font>


```{r wfhp, fig.height=8, fig.width=11}
knitr::include_graphics("wfhp.jpg") 
```

<br>

<font size="6"> WUI! Change since 1990. From Radeloff et al., 2018. </font>

<br>

```{r wui, fig.height=8, fig.width=11}
knitr::include_graphics("F3.large.jpg") 
```


<br>

<font size="6"> What's being done? 

<br>

See https://www.nature.org/en-us/what-we-do/our-priorities/protect-water-and-land/land-and-water-stories/why-we-work-with-fire/ for examples </font>
...
### <b><font  size="4em" color="#000000">Fire patterns are changing.</font></b>   
While we have millions fewer acres of fire today than we did prior to European Colonization, we have ~328,000,000 people and ~44,000,000 houses in the Wildland Urban Interface.


Historical fire by state-OUTTAKE
========================================================
## blah
...
Past vs. Present-a look by region--DRAFT
========================================================
## blah
